...
import Cake from "../Animated Cake /Cake";
...
const FireworksCanvas = () => {
  ...
  useEffect(() => {
    ...
    const opts = {
      strings: ["The saga continues, 17!", "Stepping into his Legendary Era ... ", "Happy", "Birthday,", "Ishi "],
      // strings: ["HAPPY", "BIRTHDAY", "Sharvari"],
      charSize: 30,
      charSpacing: 35,
      lineHeight: 40,
      cx: w / 2,
  ...
  useEffect(() => {
    ...
    }, 12000); // Delay before starting fade-out 12000

    const exitTimer = setTimeout(() => {
      setShowBalloons(true);

    }, 10000); // Delay before starting fade-out 12000
  ...
  return (
    ...
    //     <canvas
    //       ref={canvasRef}
    //       className="fireworkCanvas relative top-0 left-0 z-1"
    //     />
    //     {/* to implement |^| */}
    //     {/* </div> */}
    //     {/* <div className="secondComponent">
    //       <BalloonCanvas className="BalloonCanvas absolute top-0 left-0 w-[100%] h-[100%] " />
    ...
    <>
      <div className='firstComponent'>
        <div className="canvas-container relative">
          <canvas
            ref={canvasRef}
            className={`fireworkCanvas relative top-0 left-0 z-1 ${showCake ? 'opacity-0':''}`}
          />
          {showCake && (<><div className="text-3xl text-black flex z-[100000] cakeKhaa absolute left-[42%] top-[20%]">Ye le, Cake Khaa 😋</div> <Cake/> </>)}
          {showBalloons && <BalloonCanvas />}
        </div>
      </div>
      {/* <div className='secondComponent'> */}
        {/* <BalloonCanvas className="BalloonCanvas absolute top-0 left-0 w-[100%] h-[100%]" /> */}
