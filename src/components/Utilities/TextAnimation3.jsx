...
function TextAnim3( ) {
  ...
  const [isComplete, setIsComplete] = useState(false);
    ...
    const dataText = [
      ...
      " 2. The developer was not treated well at times, his only fault was that he wanted to celebrate the day, a day which he was waiting since last October.",
      ...
      " 4. Promises made by the recipient are never kept !!!!!!",
    ];
